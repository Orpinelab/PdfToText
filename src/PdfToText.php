...
namespace orpine\pdftotext;

use orpine\pdftotext\Exceptions\CouldNotExtractText;
use orpine\pdftotext\Exceptions\PdfNotFound;
...
class PdfToText
{
    ...
    {
        $this->binPath = $binPath?$binPath:'C:\\catsbin\pdftotext.exe';
    }
    ...
    public static function getText( $pdf,  $binPath = null, array $options = [])
    {
